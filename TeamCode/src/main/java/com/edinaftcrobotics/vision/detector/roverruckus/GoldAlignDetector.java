...
import com.edinaftcrobotics.vision.filter.*;
...
public class GoldAlignDetector extends BaseDetector {
    ...
    public AreaScoringMethod areaScoringMethod = AreaScoringMethod.MAX_AREA; // Setting to decide to use MaxAreaScorer or PerfectAreaScorer
    ...
    public void useDefaults() {
        ...
        if(areaScoringMethod == AreaScoringMethod.MAX_AREA){
            addScorer(maxAreaScorer);
        }

        if (areaScoringMethod == AreaScoringMethod.PERFECT_AREA){
